...
class Boid(Rules):
    ...
    def update(self, boids, boidguards, ALIGNMENT, COHESION, SEPARATION, green_reached):
        ...
        possible_velocity2 = Rules.tend_to_place(self,green_reached)
        possible_position2 = self.position + possible_velocity2
        ...
        if self.is_black(possible_position2) == False:
            self.velocity = Rules.tend_to_place(self,green_reached)
